...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'ro', data: { breadcrumb: 'Release Orchestration' }, loadChildren: () => import('./demo/components/releaseorchestration/releaseorchestration.module').then(m => m.ReleaseOrchestrationModule) },
